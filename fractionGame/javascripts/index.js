...
// Happens when the mouse is clicked in the canvas
	...
	$('#myCanvas').click(function (e) {
	    ...
	    if (clickedX < (bottomRightButton.x+bottomRightButton.width) && clickedX > rightButton.x && clickedY > bottomRightButton.y && clickedY < (bottomRightButton.y+bottomRightButton.height)) {
	        alert ('clicked Bottom Right Answer');
	    }
	});
